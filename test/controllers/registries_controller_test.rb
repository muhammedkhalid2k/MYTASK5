...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference("Registry.count") do
      post registries_url, params: { registry: { coordinator_id: @registry.coordinator_id, location: @registry.location, name: @registry.name, participant_id: @registry.participant_id, state: @registry.state } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { coordinator_id: @registry.coordinator_id, location: @registry.location, name: @registry.name, participant_id: @registry.participant_id, state: @registry.state } }
